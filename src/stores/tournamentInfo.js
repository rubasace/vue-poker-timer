...
export const useTournamentInfoStore = defineStore({
    ...
    state: () => ({
        ...
        entryRake: useLocalStorage('vue-poker-timer-entry-rake', 0),
        ...
        addonRake: useLocalStorage('vue-poker-timer-addon-rake', 0),
        ...
        reentryRake: useLocalStorage('vue-poker-timer-reentry-rake', 0),
